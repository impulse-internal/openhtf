...
class BuildProtoCommand(Command):
    ...
    def initialize_options(self):
        ...
        try:
            prefix = (
                subprocess.check_output("pkg-config --variable prefix protobuf".split())
                .strip()
                .decode("utf-8")
            )
            ...
            if platform.system() == "Linux":
                ...
                print(
                    "Warning: mfg-inspector output is not fully implemented for "
            ...
            try:
                ...
                if e.errno == errno.ENOENT:
                    ...
                    if sys.platform.startswith("linux"):
                        print(
                            "On many Linux systems, this is fixed by installing the "
                ...
                print(
                    "This could be due to missing helper files. On many Linux "
...
class PyTestCommand(test):
    ...
    user_options = [
        ...
        (
            "pytest-cov=",
            None,
            "Enable coverage. Choose output type: "
